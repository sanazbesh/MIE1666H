...
from src.problem import nmKnapsack_synergy, msKnapsack_synergy
...
round_method_list = ['classfication']
...
for round_method in round_method_list:
    for num_var, num_ineq in prob_size_list:

        print('-'*70)
        print('-'*70)
        print('Initiating for problems of the size of %i * %i (Rounding method: %s)' % (num_var, num_ineq, round_method))
        print('-'*70)
        ...
        components = set_components(round_method, num_var, num_ineq, hlayers_sol, hlayers_rnd, hwidth)
        ...
        print('-'*70)
        print('Summary results of run_kanpsack_synergy for problems of the size of %i * %i (Rounding Method: %s)' % (num_var, num_ineq, round_method))
        print('-'*70)
...
#     num_data = 1500         # number of data
#     test_size = 150          # number of test size
#     val_size = 150          # number of validation size
#     train_size = num_data - test_size - val_size
